...
//pub static GIT_COMMIT_HASH: &'static str = env!("HELLO_RATATUI_GIT_INFO");
...
pub fn initialize_logging() -> Result<()> {
    ...
    //std::env::set_var is safe for single threaded applications.  Since this is only called once in this multi-threaded application at
    //startup it will be consirded safe.
    unsafe {
        std::env::set_var(
            "RUST_LOG",
